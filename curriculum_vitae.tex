...
\item Totta Ehret, Simone Spork, Christoph Dieterich, Richard Lucius
  ...
  falciformis To Host Immune Defences. BMC Genomics accepted.
...
% \begin{itemize}
% \item Reviewer activity (journals): \textit{BMC Genomics}
%   \textit{Parasites \& Vectors}, \textit{The Journal of Parasitology},
%   \textit{Parasitology research}
% \item Thesis committee membership: 
%   \begin{itemize}
%   \item[2014] one review for a doctoral thesis
%   \end{itemize}
%   %   % \item [2010--Present] Member, foo2.
% \end{itemize}
