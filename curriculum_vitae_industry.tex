...
\begin{itemize}
\item [2011-ongoing] Postdoctoral Researcher, Humboldt University
  Berlin, Institute for Biology, Department for Molecular Parasitology.
...
\begin{itemize}
  \item R: Expert level
  \item Shell: Expert level
  \item Perl: Advanced level
  \item Lisp: Advanced level
  \item Python: Intermediate level
  \item C/C++: Beginner level
\end{itemize}

\subsection*{Tools and Systems} 
\begin{itemize}
  \item SQL Databases: MySQL, PostgreSQL, SQLite
  \item Markup languages: \LaTeX, Html, Sweave
  \item Emacs editor
